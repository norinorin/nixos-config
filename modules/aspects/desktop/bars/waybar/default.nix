{den, ...}: {
  ...
  in {
    ...
    homeManager = {
      ...
      # TODO: define options for these when we get to multi host
      # so each host can define them
    ...
    provides.niri = {
      homeManager = {
        ...
        systemd.user.services.waybar-niri = mkWaybar {inherit pkgs config lib;} {
          variant = "niri";
